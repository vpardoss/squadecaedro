...
* La información de los recorridos de Red es obtenida de **api-red**, un proyecto desarrollado por [Xor.cl en GitHub](https://github.com/xorcl/api-red).
...
* Los mapas vectoriales de la RM fueron obtenidos de [enlace](https://www.bcn.cl/siit/mapas_vectoriales).
